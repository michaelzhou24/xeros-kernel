...
/***********************************************/
    ...
    for(int i = 0; i < MAX_FD; i++) {
        p->fd_table[i].major = -1;
        p->fd_table[i].dvname = NULL;
        p->fd_table[i].dev_ptr = NULL;
        p->fd_table[i].data = NULL;
    ...
    p->sig_handlers[31] = &kill_sig_handler;
    p->allowed_sig = 1 << 31;
